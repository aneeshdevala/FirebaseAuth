...
class UtilProvider extends ChangeNotifier {
  ...
  void disposeVariables(ctx) {
    final signUpPro = Provider.of<AuthProvider>(ctx, listen: false);
    final loginPro = Provider.of<AuthProvider>(ctx, listen: false);
